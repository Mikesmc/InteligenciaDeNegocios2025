...
-- Seleccionar el nombre completo del empleado, el correo, seleccionar el correo disponible utilizando un coalesce, comprobar si el telefono esta null si es asi poner la palabra no disponible tambien validar el bonus si es null obligarlo a ser cero y si es cero poner la palabra sin bono, y si no es cero concatenar el bonus anteponiendoel simbolo de $
