...
CAST([Address] AS VARCHAR (120)) AS [Adress],
...
--Insertar registros en metadata
...
truncate table Stage_Empleado;


--Obtener el maximo ETLEXecution de la tabla Load_Northwind.dbo.employee

select MAX(ETLExecution)
from Load_Northwind.dbo.Employees
